package ir.awlrhm.areminder.view.acalenar;
...
import ir.awlrhm.areminder.view.acalenar.animator.CalendarAnimation;
...
import ir.awlrhm.areminder.view.acalenar.listener.AnimationsListener;
import ir.awlrhm.areminder.view.acalenar.listener.PageViewListener;
import ir.awlrhm.areminder.view.acalenar.listener.SmallAnimationListener;
import ir.awlrhm.areminder.view.acalenar.listener.SmallPageChangeListener;
import ir.awlrhm.areminder.view.acalenar.model.CustomGradientDrawable;
import ir.awlrhm.areminder.view.acalenar.model.MarkSetup;
...
//        initAnimation();
    ...
    protected void setupMiddleContainerFromAttr(TypedArray typedArray) {
        if (typedArray.hasValue(R.styleable.PersianHorizontalExpCalendar_center_container_expanded_height)) {
            monthViewPagerHeight = typedArray.getDimensionPixelSize(
                    R.styleable.PersianHorizontalExpCalendar_center_container_expanded_height, LayoutParams.WRAP_CONTENT);
            setCellHeight();
    ...
    public PersianHorizontalCalendar setHeightToCenterContainer(int height) {
        ((LayoutParams) centerContainer.getLayoutParams()).height = height;
    ...
    protected class PageView extends FrameLayout implements OnClickListener {
    ...
    protected class DayCellView extends BaseCellView {
        ...
        protected void addNewView(CustomGradientDrawable customGradientDrawable) {
            ...
            LayoutParams p = (LayoutParams) newView.getLayoutParams();
